...
### Source files
- `src/write_file.py` - Python program to write data to a file
- `src/read_file.py` - Python program to read data from a file
- `src/write_file.c` - C program to write data to a file
- `src/read_file.c` - C program to read data from a file

### Data folder
- `data/` - stores test files generated during file input/output experiments
